...
Feature: [LLM behavior] Simple poetry app behavior

    Background: The purpose of the poetry application is to generate nice, happy and short poems for all users who clicks the "Generate poem" button.
